...
function setup(){
    ...
    //create drops
    if(frameCount%100===0){
        rain=new Drop(random(10,390),-10,20)
        rain1=new Drop(random(10,390),-10,20)
        rain2=new Drop(random(10,390),-10,20)
        rain3=new Drop(random(10,390),-10,20)
